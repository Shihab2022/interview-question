...
> _Click <img src="assets/star.png" width="18" height="18" align="absmiddle" title="Star" /> if you like the project. Your contributions are heartily ♡ welcome._

## Table of Contents

- _[Docker Workshop](docker-practice.md)_
- _[Jenkins Interview Questions](jenkins.md)_
...
## Q. **_How will you monitor Docker in production?_**
...
## Q. **_Is it a good practice to run Docker compose in production?_**
...
## Q. **_What changes are expected in your docker compose file while moving it to production?_**
...
## Q. **_Are you aware of load balancing across containers and hosts? How does it work?_**
...
## Q. **_What is a Docker Registry?_**
...
## Q. **_How to create Docker container_**
...
## Q. **_Does Docker container package up the entire OS?_**
...
## Q. **_Describe how many ways are available to configure Docker daemon?_**
...
## Q. **_Can you list reasons why Container Networking is so important?_**
...
## Q. **_How to create a user-defined Bridge network ?_**
...
## Q. **_Can you explain different volume mount types available in Docker?_**
...
## Q. **_How to share data among DockerHost?_**
...
## Q. **_How to Backup, Restore, or Migrate data volumes under Docker container?_**
...
## Q. **_How to Configure Automated Builds on DockerHub_**
...
## Q. **_How to configure the default logging driver under Docker?_**
...
## Q. **_Why do my services take 10 seconds to recreate or stop?_**
...
## Q. **_How do I run multiple copies of a Compose file on the same host?_**
...
## Q. **_What is the difference between up, run, and start under Docker Compose?_**
...
## Q. **_What is Docker Trusted Registry?_**
...
## Q. **_How to declare default environment variables under Docker Compose?_**
...
## Q. **_Can you list out ways to share Compose configurations between files and projects under Docker Compose?_**
...
## Q. **_What is the purpose of EXPOSE command in Dockerfile?_**
...
## Q. **_Why Docker Monitoring is necessary?_**
...
## Q. **_Is it possible to run Kubernetes on Docker EE 2.0 Platform?_**
...
## Q. **_Can you use Docker Compose to build up Swarm/Kubernetes Cluster?_**
...
## Q. **_What is 'docker stack deploy' command meant for?_**
...
## Q. **_Explain the concept of HA under Swarm Mode?_**
...
## Q. **_What are Docker secrets and why is it necessary_**
...
## Q. **_What are docker networking_**
...
## Q. **_Explain a use case for Docker_**
...
## Q. **_What is the difference between the COPY and ADD commands in a Dockerfile?_**
...
## Q. **_When would you use "docker kill" or "docker rm -f"?_**
...
## Q. **_What is the difference between CMD and ENTRYPOINT in a Dockerfile?_**
...
## Q. **_Do I lose my data when the Docker container exits?_**
...
## Q. **_What is Build Cache in Docker?_**
...
## Q. **_What is the difference between "docker run" and "docker create"?_**
...
## Q. **_What is the difference between a docker registry and repository?_**
...
## Q. **_What is the default CPU limit set for a container?_**
...
## Q. **_Can you create containers without their own PID namespace_**
...
## Q. **_What is the difference between Docker Image and Layer?_**
...
## Q. **_What is the difference between "expose" and "publish" in Docker?_**
...
## Q. **_Docker Compose vs. Dockerfile - which is better?_**
...
## Q. **_What exactly do you mean by "Dockerized node"? Can this node be on-premises or in the cloud?_**
...
## Q. **_How can we control the startup order of services in Docker compose?_**
